...
<head>
	...
	<section class="order_details section_gap">
		<div class="container">
			<h1 class="title_confirmation">List Order</h1>
			<table class="table">
				<thead>
				  <tr>
				...
				<c:forEach items="${orders}" var="order">	
				  <tr>
					<th scope="row"><a href="/shop/order/${ order.orderId }">${ order.orderId }</a></th>
			...
			<div class="order_details_table">
				<h2 class="text-center">Order Details Of OrderId: ${ orderID }</h2>
