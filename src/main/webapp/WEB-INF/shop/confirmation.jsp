			...
			<div class="row order_d_inner">
				<div class="col-lg-4">
					<div class="details_item">
						<h4>Order Info</h4>
						<ul class="list">
							<li><a href="#"><span>Order number</span> : ${ order.orderId }</a></li>
							<li><a href="#"><span>Date</span> : ${ order.createdDate }</a></li>
							<li><a href="#"><span>Customer Number</span> : ${ order.customerNumber }</a></li>
							<li><a href="#"><span>Total</span> : ${ order.totalMoney }</a></li>
							<li><a href="#"><span>Payment method</span> : Check payments</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-8">
					<div class="order_details_table m-0">
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<h5>x ${ orderDetail.purchasedQuantity }</h5>
										</td>
										<td>
											<p>$${ orderDetail.purchasedMoney }</p>
										</td>
									</tr>
									</c:forEach>
									<tr>
