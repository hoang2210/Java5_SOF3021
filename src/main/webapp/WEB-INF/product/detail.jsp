				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<ul class="list">
							...
							<li><span>Nhà sản xuất: ${product.distributor}</span></li>
							<li><span>Số lượng hiện có: ${product.quantity}</span></li>
							
						</ul>
						<p>${product.productName} cao cấp và cute. Dép siêu nhẹ, êm chân và cực kỳ hot trend hiện nay. <br>
							Sản phẩm được hãng ${product.distributor} thiết kế và được phân phối bởi KARMA - shop uy tín và cam kết chất lượng, giúp bạn yên tâm mua hàng.<br> 
							Mọi thắc mắc hoặc câu hỏi, bạn đừng ngại chat với shop nhé!
						</p>
